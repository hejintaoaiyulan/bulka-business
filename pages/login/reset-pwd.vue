...
<view class="container">
  <view class="content" v-if="!isCheckOldMobile">
    ...
    <view class="submit-button">
      <uv-button custom-style="background: black; color: #fff" :hairline="false">下一步</uv-button>
    </view>
  </view>
...
<!--          <view class="iconfont icon-zhanghaozhongxinzhanghaoguanli"></view>-->
        ...
        <view class="form-value">
          <uv-input placeholder="請輸入新密碼"></uv-input>
        </view>
      </view>
      <view class="form-item">
        <view class="form-label">
<!--          <view class="iconfont icon-mima"></view>-->
    ...
    <view class="submit-button">
      <uv-button custom-style="background: black; color: #fff" :hairline="false">提交</uv-button>
    </view>
  </view>
</view>
</template>
